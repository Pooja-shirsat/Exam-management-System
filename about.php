...
<div class="row">
  <div class="column">
    <div class="card">
      <div class="container">
        ...
        <p>I performed coding part for developing this system.</p>
        <p>Email : swamini.bhand@cumminscollege.in</p>
  ...
  <div class="column">
    <div class="card">
      <div class="container">
        <center><h3>Pooja Shirsat</h3></center>
        <p class="title">Coder</p>
        <p>I also performed the coding part for developing this system.</p>
        <p>Email : pooja.shirsat@cumminscollege.in</p>
        <p>Contact : 9529291468</p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <div class="container">
        <center><h3>Suvarna Nagare</h3></center>
        <p class="title">Designer</p>
        <p>All Designing which is required to developed this system was done by me.</p>
        <p>Email : suvarna.nagare@cumminscollege.in</p>
        <p>Contact : 9881965306</p>
      </div>
    </div>
  </div>
  </div>
